...
res <- read.csv("./preprocessed_data/deseq2_results_coding_only_GG.csv", check.names = FALSE)
padj_thresh <- 0.05
logfc_thresh <- 1
...
write_csv(ego_df, "./preprocessed_data/enrichGO_pathways_with_genes_GG.csv")
...
write_csv(output_df, "./preprocessed_data/top_gsea_pathways_with_genes_GG.csv")
