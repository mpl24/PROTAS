...
merged_df <- read_csv('PATH TO NUCLEI FEATURES')
norm_methods <- read_csv('PATH TO NORMALIZATION METHOD FOR EACH NUCLEI FEATURE')
...
write_csv(results_df, "glmm_results_df_NUCLEI.csv")
